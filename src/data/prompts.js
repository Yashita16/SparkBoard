// ============================================================
// prompts.js — All game prompts, organized by tile type
// Each prompt has: id, type, text, enabled
// ============================================================

export const DEFAULT_PROMPTS = [
  // ── MOVE prompts (physical activity) ──────────────────────
...
// Helper: get prompts by type (only enabled ones)
...
// Helper: get a random prompt by type, excluding already-used ones
