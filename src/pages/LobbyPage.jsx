    ...
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-4 text-center">
          ...
          <p className="text-xs text-gray-400 mb-6">Players scan QR code or enter this code at the app</p>
          ...
          <p className="text-xs text-blue-600 break-all mb-6">{joinUrl}</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
          <p className="font-medium mb-3">Teams</p>
          <div className="space-y-2">
            {teams.map(t => (
              <div key={t.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                ...
                <span className="text-xs text-gray-400">{t.players.length} players joined</span>
              </div>
            ))}
          </div>
        </div>
